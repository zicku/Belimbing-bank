...
const apiService = {
  ...
  // Customers
  getCustomers: () => axios.get(`${API_URL}/customers`), // Asumsi ada endpoint get all customers
  ...
  // Deposito Types
  getTypes: () => axios.get(`${API_URL}/deposito-types`), // Asumsi ada endpoint get all types
  ...
  // Accounts
  getAccounts: () => axios.get(`${API_URL}/accounts`), // Asumsi ada endpoint get all accounts
